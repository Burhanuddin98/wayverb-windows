...
enum MissingOpenGLDefinitions
{
   ...
   // WGL pixel-format constants: needed on Windows regardless of whether GLEW
   // defines the core GL tokens (GLEW does NOT provide these WGL_*_ARB defines).
   #if JUCE_WINDOWS && ! defined (WGL_DRAW_TO_WINDOW_ARB)
